...
function Header() {
  return (
    <div className="flex ">
      ...
      <div className=" w-[60%] flex text-white font-bold">
        <ul className="flex items-center gap-5 uppercase text-[13px]  w-screen mt-6">
          <li className="hover:border-b-2 hover:cursor-pointer border-white hover:duration-200">
            Falcon 9
          </li>
          <li className="hover:border-b-2 hover:cursor-pointer border-white  hover:duration-200">
            Falcon heavy
          ...
          <li className="hover:border-b-2 hover:cursor-pointer border-white  ">
            starlink
          </li>
        </ul>
      </div>
      <div className=" w-[25%] h-[10vh] uppercase text-[13px] font-bold text-white">
        <ul className=" flex gap-9 items-end justify-end mr-12">
          <li className="h-[8vh] flex items-end hover:border-b-2 hover:cursor-pointer border-white hover:duration-200">
            shop
          </li>
          <li className="cursor-pointer">
            <img className="h-[4vh] " src="src/assets/bars-solid.svg" alt="" />
          </li>
        </ul>
      </div>
    </div>
